...
var droits = function(){
  Vue.use(Toasted)
  Vue.toasted.show('<div class="control"><div class="tags has-addons"><span class="tag is-primary is-light">Ibot</span><span class="tag is-info is-light">V0.4-beta.9</span></div></div><span class="tag is-info is-rounded">Proposé par A. DERA<span>',{
    theme: "outline", 
    position: "top-center", 
    duration : 3000
  });
